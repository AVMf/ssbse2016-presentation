...
\newcommand{\xmarkhide}{{\color{solarizedBase2!120}{\ding{55}}}}
...
\setbeamercolor{background canvas}{bg=solarizedBase2!120}
...
\setbeamercolor{frametitle}{fg=solarizedBase02!90}
...
\input{sections/everywhere_domains.tex}
\input{sections/introduction.tex}

\section{Motivation}
\input{sections/innovations.tex}
\input{sections/missing_innovations.tex}
\input{sections/everywhere_tools.tex}
\input{sections/extracting_features.tex}

\section{Details}
\input{sections/introduce_avmf.tex}
\input{sections/design_avmf.tex}
\input{sections/demonstrate_avmf.tex}
